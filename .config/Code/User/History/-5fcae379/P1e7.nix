  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        "$mainMod SHIFT, W, exec, /home/yaros/.config/waybar/kill_waybar.sh; waybar"
        ", XF86AudioMute, exec, /home/yaros/Documents/volume.sh mute"
        ...
        "$mainMod ALT, W, exec, /home/yaros/Documents/wallp-rofi.sh"
      ...
      binde = [
        ", XF86AudioRaiseVolume, exec, /home/yaros/Documents/volume.sh up"
        ", XF86AudioLowerVolume, exec, /home/yaros/Documents/volume.sh down"
      ...
      windowrule = [
        "float, (org.gnome.SystemMonitor)|(nm-tray)|(clocks)|(pavucontrol)|(gnome-power-statistics)|(blueman)|(.scrcpy-wrapped)"
        "tile, (.scrcpy-wrapped)"
      ...
      "plugin:overview" = {
        ...
        disableBlur = "true";
        #panelColor = "$color1";
        panelBorderColor = "$color2";
        workspaceActiveBackground = "$color3";
        workspaceInactiveBackground = "$color4";
        workspaceActiveBorder = "$color5";
        workspaceInactiveBorder = "$color6";
        dragAlpha = "0.7";
        onBottom = "true";
      };
