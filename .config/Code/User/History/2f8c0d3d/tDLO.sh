...
cp "/$path" ~/shared/Projects/sddm-sugar-dark/Background.$extension
cp "/$path" ~/shared/CurrentWallpaper/Background1.$extension
cp "/$path" ~/shared/CurrentWallpaper/Background2.$extension
pkill dunst 
