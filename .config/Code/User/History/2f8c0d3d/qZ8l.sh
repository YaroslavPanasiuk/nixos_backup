...
cp ~/.cache/wal/_variables.css ~/.mozilla/firefox/0mi1kkn9.default/chrome/styles/_variables.css
...
cp "/$path" ~/.mozilla/firefox/0mi1kkn9.default/chrome/styles/ASSETS/wallpaper/wallpaper.png

pkill dunst 
~/.config/waybar/update_telegram.sh -B
