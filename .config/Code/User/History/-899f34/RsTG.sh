#!/bin/sh
greetings=("Hello Yarych" "Wassupp myman" "Welcome" "Feeling good?" "Добрий день" "Здоров Панас" "Let's do some coding" "Ure ure ure" "Touch some grass" "Get a job" "Omae wa mu sindeiru")
